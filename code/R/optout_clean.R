...
client_id = 1074
data1 <- read.csv(paste("~/Desktop/Data Projects/ST/data/profile.", client_id, "_eng__ET72012-03-20.txt", sep=''), header=F)


data2 <- read.csv(paste("~/Desktop/Data Projects/ST/data/profile.", client_id, "_eng__ET72012-03-25.txt", sep=''), header=F)
...
#data <- data1[which(data1$optout==0),]
#data = data1
...
source('~/Desktop/Data Projects/ST/code/gbm_model.R')
